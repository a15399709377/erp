		...
		<form class="layui-form">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input number" placeholder="请输入搜索的内容" />
				</div>
  ...
  //用户列表
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'number', title: '账户', width:150,align:"center",sort:true},
            {field: 'password', title: '密码', width:150,align:"center",sort:true},
            {field: 'uname', title: '姓名', width:180, align:"center",sort: true},
            {field: 'level', title: '权限等级', width:180,align:"center",sort:true},
            {field: 'img', title: '头像', width:180,align:"center",sort:true},
            {field: 'synopsis', title: '简介', width:180,align:"center",sort:true},
    ...
    function addUser(edit){
        ...
        var index = layui.layer.open({
            ...
            success : function(layero, index){
                ...
                if(edit){
                	//body.find(".uid").attr("disabled",false);
                	body.find(".uid").val(edit.uid);
                	//body.find(".unumber").attr("disabled",false);
                	body.find(".unumber").val(edit.number);
